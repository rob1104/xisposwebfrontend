...
code = code.replace(/<q-item-label header class="menu-header">Administracin<\/q-item-label>/g, '<q-item-label v-if="hasAdministracionAccess" header class="menu-header">Administración</q-item-label>');
code = code.replace(/<q-item-label header class="menu-header">Administración<\/q-item-label>/g, '<q-item-label v-if="hasAdministracionAccess" header class="menu-header">Administración</q-item-label>');
