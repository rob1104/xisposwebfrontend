const routes = [
  {
    ...
    children: [
      ...
      { path: 'reportes/traspasos', component: () => import('pages/Reportes/TraspasosReporte.vue'), name: 'reportestraspasos', meta: { permission: 'reportes.traspasos' } },
      ...
      { path: 'restaurante', component: () => import('pages/Restaurante/RestaurantePage.vue'), name: 'restaurante', meta: { hideLayout: true, permission: 'restaurante.ver' } },
    ]
  },
  {
    path: '/login',
